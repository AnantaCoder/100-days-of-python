...
try:
    data = pandas.read_csv("day-31 flash card app//data//words_to_learn.csv")
except FileNotFoundError:
    original_data = pandas.read_csv("day-31 flash card app//data//french_words.csv")
...
def is_known():
    ...
    learn_data.to_csv("day-31 flash card app//data//words_to_learn.csv", index=False)
...
card_front_png = PhotoImage('day-31 flash card app//images//card_front.png')
card_back_png = PhotoImage('day-31 flash card app//images//card_back.png')
...
wrong_png = PhotoImage(file="day-31 flash card app//images//wrong.png")
wrong_button = Button(image=wrong_png, highlightthickness=0, command=next_card)
wrong_button.grid(column=0, row=1)

right_png = PhotoImage(file="day-31 flash card app//images//right.png")
